<?
	...
	switch($type){
		...
		case "request":
			...
			/*if($insert_ervices_dop == ''){
				$template=str_replace("{insert_ervices_dop}",' ',$template);
			}*/
			...
			if(count($result["shipings"]) > 0){
				
				$dop_tempate = '';
				
				foreach($result["shipings"] as $key=>$val0){
					
					if($key > 0){
						
						$template2=file_get_contents("./templates/request2.html");
						$template2=str_replace("{doc_barcode}",$result["doc_barcode"],$template2);
						$template2=str_replace("{departure}",$val0["departure"],$template2);
						$template2=str_replace("{destination}",$val0["destination"],$template2);
						$template2=str_replace("{short_Name1}",$val0["countragents"][1]['short_Name'],$template2);
						$template2=str_replace("{short_Name2}",$val0["countragents"][2]['short_Name'],$template2);
						$template2=str_replace("{inn1}",$val0["countragents"][1]['inn'],$template2);
						$template2=str_replace("{inn2}",$val0["countragents"][2]['inn'],$template2);
						$template2=str_replace("{phone_1}",$val0["countragents"][1]["contacts"][0]['phone_1'],$template2);
						$template2=str_replace("{phone_2}",$val0["countragents"][2]["contacts"][0]['phone_1'],$template2);
						$template2=str_replace("{address1}",$val0["countragents"][1]['address'],$template2);
						$template2=str_replace("{address2}",$val0["countragents"][2]['address'],$template2);
						$template2=str_replace("{short_Name3}",$val0["countragents"][0]['short_Name'],$template2);
						$template2=str_replace("{address3}",$val0["countragents"][0]['address'],$template2);
						$template2=str_replace("{inn3}",$val0["countragents"][0]['inn'],$template2);
						$template2=str_replace("{phone_3}",$val0["countragents"][0]["contacts"][0]['phone_1'],$template2);
						...
						if(count($val0["cargos"]) > 0){
							...
							foreach($val0["cargos"] as $key => $val){
							...
							$template2=str_replace("{character}",$strNames,$template2);
							$template2=str_replace("{places}",$placesMain,$template2);
							$template2=str_replace("{weight}",$weightMain,$template2);
							$template2=str_replace("{amount}",$amountMain,$template2);
							$template2=str_replace("{places1}", $places3,$template2);
							$template2=str_replace("{weight1}", $weight3,$template2);
							$template2=str_replace("{amount1}", $amount3,$template2);
							$template2=str_replace("{places2}", $places1,$template2);
							$template2=str_replace("{weight2}", $weight1,$template2);
							$template2=str_replace("{amount2}", $amount1,$template2);
							$template2=str_replace("{places3}", $places2,$template2);
							$template2=str_replace("{weight3}", $weight2,$template2);
							$template2=str_replace("{amount3}", $amount2,$template2);
						}else{
							$template2=str_replace("{character}",$val0["cargos"][0]['character'],$template2);
							$template2=str_replace("{places}",$val0["cargos"][0]['places'],$template2);
							$template2=str_replace("{weight}",$val0["cargos"][0]['weight'],$template2);
							$template2=str_replace("{amount}",$val0["cargos"][0]['amount'],$template2);
							$template2=str_replace("{places1}",$val0["cargos"][0]['mark_ups'][2]['pwa']['places'],$template2);
							$template2=str_replace("{weight1}",$val0["cargos"][0]['mark_ups'][2]['pwa']['weight'],$template2);
							$template2=str_replace("{amount1}",$val0["cargos"][0]['mark_ups'][2]['pwa']['amount'],$template2);
							$template2=str_replace("{places2}",$val0["cargos"][0]['mark_ups'][0]['pwa']['places'],$template2);
							$template2=str_replace("{weight2}",$val0["cargos"][0]['mark_ups'][0]['pwa']['weight'],$template2);
							$template2=str_replace("{amount2}",$val0["cargos"][0]['mark_ups'][0]['pwa']['amount'],$template2);
							$template2=str_replace("{places3}",$val0["cargos"][0]['mark_ups'][1]['pwa']['places'],$template2);
							$template2=str_replace("{weight3}",$val0["cargos"][0]['mark_ups'][1]['pwa']['weight'],$template2);
							$template2=str_replace("{amount3}",$val0["cargos"][0]['mark_ups'][1]['pwa']['amount'],$template2);
						}
						...
						$template2=str_replace("{spec_height}", "100px;",$template2);
						if(count($val0["services"][0]["service_in"]) > 0){

							$coll = count($val0["services"][0]["service_in"]);
							$collNoQoantity = 0;


							foreach($val0["services"][0]["service_in"] as $key=>$val){
								if($val['quantity'] != 0){
						...
						//doc_rezerve2
						$template2=str_replace("{doc_rezerve2}",$val0["doc_rezerve2"],$template2);
						$template2=str_replace("{colservices}",$coll_insert_ervices_dop,$template2);
						$template2=str_replace("{insert_ervices_dop}",$insert_ervices_dop,$template2);
						/*if($insert_ervices_dop == ''){
							$template=str_replace("{insert_ervices_dop}",' ',$template);
						}*/

						$template2=str_replace("{address4}",$val0["expedition"][0]["address"],$template2);	
						$template2=str_replace("{address5}",$val0["expedition"][1]["address"],$template2);
						$template2=str_replace("{fio4}",$val0["expedition"][0]["contacts"][0]["fio"],$template2);
						$template2=str_replace("{fio5}",$val0["expedition"][1]["contacts"][0]["fio"],$template2);
						$template2=str_replace("{phone_4}",$val0["expedition"][0]["contacts"][0]["phone_1"],$template2);
						$template2=str_replace("{phone_5}",$val0["expedition"][1]["contacts"][0]["phone_1"],$template2);

						$template2=str_replace("{data_expedition4}",$val0["expedition"][0]["data_expedition"],$template2);	
						$template2=str_replace("{data_expedition5}",$val0["expedition"][1]["data_expedition"],$template2);

						$template2=str_replace("{time_expedition4}",$val0["expedition"][0]["time_expedition"],$template2);	
						$template2=str_replace("{time_expedition5}",$val0["expedition"][1]["time_expedition"],$template2);
						
						
						
						$dop_tempate .= $template2;
						
					}
					
				}
				$template = str_replace("{insert_dop_perevoska}", $dop_tempate, $template);
			}else{
				$template = str_replace("{insert_dop_perevoska}", ' ', $template);
			}
