...
<div class="pw relative k-content">
    ...
    <div id="example">
        <div class="demo-section k-content">
            <h4><label for="">Choose shipping countries:</label></h4>
            <input id="countries" class="countries" style="width: 100%;" />
				...
				<div class="wrp">
					...
					<p style="font-size:small;">
						...
						<br/>
								...
								<input type="text" id="customer-Contact_Id" class="ServiceInput k-textbox" name="customer_Contact" style="width:92%;" />
						<br/>
							<div class=dfull>
								<div class=d2l>
            ...
            <div class="row">
                ...
                <div id="mini-calc_List" style="position:inherit; padding:0;">
                    <div class="d2l">
                        ...
                        <div id="city_from_List1" class="city-select_List1 " style="width:400px;">
                        ...
                        <div class="mla" id="div_BOXDeliveryOut_Id" style="margin:0px;">
    						...
    						<div class="data-show-content-yourself">
                                <label class="titel-form-order required" style="margin-right:190px">Когда</label><label class="titel-form-order required" style="padding-right: 20px;">Во сколько (часы)<img src="https://www.sibtrans.ru/bitrix/templates/main/images/question.png"></label><br/>

								<input name="DateDeliveryCust" id="DateDeliveryCust_Id" type="text" class="ServiceInput" style="width:147px;" readonly="readonly"  placeholder="__.__.____"/>

								<label class="titel-form-order titel-addres" style="vertical-align:middle; padding:4px;">&nbsp;с</label>
								<input name="Hour1DeliveryCust" id="start" value="8:00" style="width: 90px;" maxlength="5" id="Hour1DeliveryCust_Id" type="text" class="ServiceInput numbers" style="width:40px; text-align:center;" placeholder="__" />

								<label class="titel-form-order titel-addres" style="vertical-align:middle; padding:4px;">по</label>
								<input name="Hour2DeliveryCust" id="end" value="15:00" style="width: 90px;" maxlength="5" id="Hour2DeliveryCust_Id" type="text" class="ServiceInput numbers" style="width:40px; text-align:center;" placeholder="__" />
                            </div>
