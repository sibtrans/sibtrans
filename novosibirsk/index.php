...
$APPLICATION->SetPageProperty("description", "Перевозка грузов Новосибирск — Транспортная Компания «Байт Транзит». Грузоперевозки в любом объёме: железнодорожным, автомобильным, морским и авиатранспортом по России и всему Миру!");
$APPLICATION->SetPageProperty("TITLE", "Грузоперевозки Новосибирск — Транспортная Компания «Байт Транзит»");
