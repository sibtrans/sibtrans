...
$APPLICATION->SetPageProperty("description", "Перевозка грузов Иркутск — Транспортная Компания «Байт Транзит». Грузоперевозки в любом объёме: железнодорожным, автомобильным, морским и авиатранспортом по России и всему Миру!");
$APPLICATION->SetPageProperty("keywords", "Иркутск, транспортная компания, Байт Транзит, грузоперевозки, доставка грузов, перевозка грузов");
$APPLICATION->SetPageProperty("TITLE", "Грузоперевозки Иркутск — Транспортная Компания «Байт Транзит»");
$APPLICATION->SetTitle("Иркутск");
?> 
