...
<pre><?print_r($_POST['selected']); ?><? /*$j = json_encode($_POST['selected'], JSON_UNESCAPED_UNICODE); echo $j;*/ ?></pre>
...
foreach($_POST['selected'] as $item){
	...
	if($item["ID"]=="duble_data_user1"){
		$duble_data_user1 = $item["value"];
	}
	if($item["ID"]=="duble_data_user2"){
		$duble_data_user2 = $item["value"];
	}
	if($item["ID"]=="duble_data_user3"){
		$duble_data_user3 = $item["value"];
	}
...
function OrderSend($from, $to, 
					...
					$tarifs__data,
				  	$Code_1c, $duble_data_user1, $duble_data_user2, $duble_data_user3, $NameSC, $ID_SC)
{
	...
	$duble1 = "";
	if($duble_data_user1 == 'Y'){
		$duble1 = $Code_1c;
	}
	$duble2 = "";
	if($duble_data_user2 == 'Y'){
		$duble2 = $Code_1c;
	}
	$duble3 = "";
	if($duble_data_user3 == 'Y'){
		$duble3 = $Code_1c;
	}
...
?><pre><? echo json_encode($data, JSON_UNESCAPED_UNICODE);?></pre><?
