...
$APPLICATION->SetPageProperty("description", "Перевозка грузов Томск — Транспортная Компания «Байт Транзит». Грузоперевозки в любом объёме: железнодорожным, автомобильным, морским и авиатранспортом по России и всему Миру!");
$APPLICATION->SetPageProperty("TITLE", "Грузоперевозки Томск — Транспортная Компания «Байт Транзит»");
$APPLICATION->SetTitle("Томск");
?> 
