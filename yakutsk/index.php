...
$APPLICATION->SetPageProperty("TITLE", "Грузоперевозки Якутск — Транспортная Компания «Байт Транзит»");
$APPLICATION->SetPageProperty("description", "Перевозка грузов Якутск — Транспортная Компания «Байт Транзит». Грузоперевозки в любом объёме: железнодорожным, автомобильным, морским и авиатранспортом по России и всему Миру!");
$APPLICATION->SetTitle("Якутск");
?> 
