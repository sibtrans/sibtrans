...
$APPLICATION->SetPageProperty("TITLE", "Грузоперевозки Улан-Удэ — Транспортная Компания «Байт Транзит»");
$APPLICATION->SetPageProperty("description", "Перевозка грузов Улан-Удэ — Транспортная Компания «Байт Транзит». Грузоперевозки в любом объёме: железнодорожным, автомобильным, морским и авиатранспортом по России и всему Миру!");
$APPLICATION->SetTitle("Улан-Удэ");
?> 
