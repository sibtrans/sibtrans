...
<link rel="stylesheet" href="https://kendo.cdn.telerik.com/2018.2.620/styles/kendo.common-office365.min.css" />
<link rel="stylesheet" href="https://kendo.cdn.telerik.com/2018.2.620/styles/kendo.office365.min.css" />
<link rel="stylesheet" href="https://kendo.cdn.telerik.com/2018.2.620/styles/kendo.office365.mobile.min.css" />
...
<style type="text/css">
    ...
    .txt-search input, .city-select_List input

    .txt-search input, .city-select_List input {
        background: white;
    }

    #max_calc input, #max_calc textarea, #max_calc select {
        width: 340px;
    }
    ...
    #menu-current-order a:hover {
        color: #8e211e;
        background-color: #BCBCBC;
    }

    #menu-current-order a {
        color: black;
        padding: 10px;
        display: block;
    }
...
<script type="text/javascript">
    ...
    function SubmitFormValidator(ChangeTabsValid) {
        ...
        if ($('#typeClientSend_ur_id').is(':checked')) {
            ...
            sender_ur_Contact.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_ur_Name.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_ur_OrgPravForm.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_ur_INN.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_ur_Phone.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_fis_Contact.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_fis_NDoc.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            sender_fis_SDoc.normalizer = function (value) {
                return $.trim(value);
            };
        ...
        if ($('#typeClientResiv_ur_id').is(':checked')) {
            ...
            resiv_ur_Name.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_ur_OrgPravForm.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_ur_Contact.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_ur_INN.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_fis_SDoc.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_fis_NDoc.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            resiv_fis_Contact.normalizer = function (value) {
                return $.trim(value);
            };
        ...
        if ($('#typeClientPay_ur_id').is(':checked')) {
            ...
            pay_ur_Name.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            pay_ur_OrgPravForm.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            pay_ur_Contact.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            //pay_ur_INN.inn = true;
            pay_ur_INN.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            pay_fis_SDoc.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            pay_fis_NDoc.normalizer = function (value) {
                return $.trim(value);
            };
            ...
            pay_fis_Contact.normalizer = function (value) {
                return $.trim(value);
            };
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#form-calk-order').unbind('submit').on('submit', function (e) {
            ...
            $('input[type="text"]').each(function () {
                ...
                selected.push({
                    ID: $(this).attr('data-IDcheckbox'),
                    value: $(this).val(),
                    name: $(this).attr('name'),
                    wvc: $(this).attr('data-wvc')
                });
    ...
    function OrderSend() // отправка заявки
    {
        ...
        // звонок
        selected.push({
            ID: $('#get-callback_Id').attr('id'),
            value: $('#get-callback_Id').is(':checked'),
            name: $('#get-callback_Id').attr('name')
        });
        ...
        if ($('#typeClientSend_fis_id').is(':checked') == true) {
            selected.push({
                ID: $("#sender-fis-TypeDoc_Id").attr('id'),
                value: $("#sender-fis-TypeDoc_Id option:selected").text()
            });
        }
        if ($('#typeClientResiv_fis_id').is(':checked') == true) {
            selected.push({
                ID: $("#resiv-fis-TypeDoc_Id").attr('id'),
                value: $("#resiv-fis-TypeDoc_Id option:selected").text()
            });
        }
        if ($('#typeClientPay_fis_id').is(':checked') == true) {
            selected.push({
                ID: $("#pay-fis-TypeDoc_Id").attr('id'),
                value: $("#pay-fis-TypeDoc_Id option:selected").text()
            });
        }
        ...
        selected.push({
            ID: $('#customer-More-information_Id').attr('id'),
            value: $('#customer-More-information_Id').val()
        });
        ...
        if (searchText('sbornieGrusPerPoRossii', current_id)) {
            current_id_val = "1";
        }
        if (searchText('VidelTransPoRossii', current_id)) {
            current_id_val = "2";
        }
        if (searchText('megdunarodGrusoper', current_id)) {
            current_id_val = "3";
        }
        ...
        selected.push({
            ID: 'ID_Character',
            value: $('#city_from_List_cc input').attr("selectedid"),
            data_val: $('#form-calk-order').find('#city_from_List_cc input').val()
        });
...
<div class="pw relative">
    ...
    <br/><br/><br/><br/><br/><br/>
    <h2 class="page-title" style="margin-left: 6%">Оформить заявку</h2>
    <div id="example">
        ...
        <script>
            ...
            $(document).ready(function () {
                // var data = $.parseJSON('[["1","aaaaaa","1"],["2","bbbbbbb","2"],["3","ccccccc","3"]]')
                ...
                $(".countries").kendoAutoComplete({
                    ...
                    dataSource: data,
                    footerTemplate: '<span >Найдено #: instance.dataSource.total() # совпадений</span>',
                    template: '<span style="font-size: medium;" class=""><p>#: data.city #, #: data.region #</p></span>',
    ...
    <form action="" method="post" id="form-calk-order" name="form-calk">
        ...
        <div id="max_calc_result">
            ...
            <div class="wrp">
                ...
                <a onclick="addURL(this)" href="../rates/sbornye-avto-zhd-perevozki.php">Посмотреть
                    прайс-лист</a><br/><br/>
                ...
                <input type="text" id="customer-Contact_Id" class="ServiceInput k-textbox" name="customer_Contact"
                       style="width:100%;"/>
                <br/>
                <div class=dfull>
                    <div class=d2l>
                        <label class="required">Контактный телефон</label><br/>
                        <input type="text" name="customer_Phone" id="customer-Phone_Id" class="ServiceInput"
                               style="width:92%;"/>
                    </div>
                    <br/>
                    <div class=d2r>
                        <label class="required">Контактный e-mail</label><br/>
                        <input type="text" maxlength="100" name="customer_Email" id="customer_Email_Id" type="email"
                               class="ServiceInput" style="width:92%;"/>
                    </div>
                </div>
                <br/>
                <label>Более подробная информация</label><br/>
                <textarea id="customer-More-information_Id" rows="5" name="customer_More_information" cols="43"
                          type="text" class="ServiceInput" maxlength="500"></textarea>
                <br/><br/>
        ...
        <div id="max_calc">
            ...
            <div id="menu-current-order">
                <div class="type-transp"><a id="sbornieGrusPerPoRossii"
                                            style="color:rgb(142, 33, 30); background-color: rgb(160, 160, 160);"
                                            data-ordertype="current">Сборные грузоперевозки<br/>по России</a></div>
                <div class="type-transp"><a id="VidelTransPoRossii">Выделенный транспорт<br/>по России</a></div>
                <div class="type-transp" style="border-right:none;">
            ...
            <div class="row">
                ...
                <div id="mini-calc_List" style="position:inherit; padding:0;">
                    <div class="d2l">
                        ...
                        <h3><label for="countries" style="margin-bottom: 6px; margin-left: 14px; font-size: larger" class="required"><strong>Пункт отправления:</strong></label></h3>

                        <div id="city_from_List" class="city-select_List" style="width:340px;">
                        ...
                        <div class="mla" id="div_BOXDeliveryOut_Id" style="margin:0px;">
                            <br/>
                            <input type="radio" name="BOXDeliveryOutServiceOrYourSelf" style="width:5%; margin-left:0;"
                                   id="BOXDeliveryOut_Id"
                                   data-show=".next" <? if ($_GET['BOXDeliveryOut_Id'] == "true") {
                                echo 'checked';
                            } ?>><label for="BOXDeliveryOut_Id" style="margin-right:10px;">забрать груз</label>

                            <input type="radio" name="BOXDeliveryOutServiceOrYourSelf" style="width:5%;"
                                   id="yourself_BOXDeliveryOut_Id"
                                   data-show-yourself=".next" <? if ($_GET['BOXDeliveryOut_Id'] !== "true") {
                                echo 'checked';
                            } ?>><label for="yourself_BOXDeliveryOut_Id">доставлю самостоятельно</label>
                            ...
                            <div class="data-show-content">
                                ...
                                <input type="text" maxlength="200" name="AddressBOXDeliveryOut"
                                       id="AddressBOXDeliveryOut_Id" class="ServiceInput" style="width:380px;"
                                       placeholder="Улица, дом, корпус" value="<?= $_GET['BOXDeliveryOut_input']; ?>"/>
                                <br/><br/>

                                <label class="titel-form-order required" style="margin-right:115px">Дата
                                    отправки</label> <label class="titel-form-order required">Время отправки
                                    (часы)</label><br/>

                                <input type="text" name="DateBOXDeliveryOut" id="DateBOXDeliveryOut_Id"
                                       class="ServiceInput" style="width:190px;" readonly="readonly"
                                       placeholder="__-__-____"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">&nbsp;с</label>
                                <input type="text" maxlength="2" name="Hour1BOXDeliveryOut" id="Hour1BOXDeliveryOut_Id"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">по</label>
                                <input type="text" maxlength="2" name="Hour2BOXDeliveryOut" id="Hour2BOXDeliveryOut_Id"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>

                                <br/><br/>
                                <label class="titel-form-order required">Контактное лицо</label>
                                <input type="text" name="ContactBOXDeliveryOut" maxlength="100"
                                       id="ContactBOXDeliveryOut_Id" class="ServiceInput" style="width:380px;"
                                       placeholder="ФИО"/>
                                <br/><br/>
                                <label class="titel-form-order required">Контактный телефон</label>
                                <input type="text" name="PhoneBOXDeliveryOut" id="PhoneBOXDeliveryOut_Id"
                                       class="ServiceInput" style="width:380px;" placeholder="Телефон"/>

                            </div>


                            <div class="data-show-content-yourself">
                                <label class="titel-form-order required" style="margin-right:190px">Когда</label><label
                                        class="titel-form-order required">Во сколько (часы)</label><br/>

                                <input name="DateDeliveryCust" id="DateDeliveryCust_Id" type="text" class="ServiceInput"
                                       style="width:190px;" readonly="readonly" placeholder="__.__.____"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">&nbsp;с</label>
                                <input name="Hour1DeliveryCust" maxlength="2" id="Hour1DeliveryCust_Id" type="text"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">по</label>
                                <input name="Hour2DeliveryCust" maxlength="2" id="Hour2DeliveryCust_Id" type="text"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>
                            </div>
                    ...
                    <div class="d2r">
                        <h3><label for="countries" style="margin-bottom: 6px; margin-left: 11px; font-size: larger" class="order-title"><strong>Пункт назначения:</strong></label></h3>

                        <div id="city_to_List" class="city-select_List" style="width:340px;">
                        ...
                        <div class="mla" id="div_BOXDeliveryIn_Id" style="margin:0px;">
                            <br/>
                            <input type="checkbox" name="BOXDeliveryIn" id="BOXDeliveryIn_Id"
                                   data-show=".next" <? if ($_GET['BOXDeliveryIn_Id'] == "true") {
                                echo 'checked';
                            } ?>>
                            ...
                            <div class="data-show-content">
                                ...
                                <input type="text" maxlength="200" name="AddressBOXDeliveryIn"
                                       id="AddressBOXDeliveryIn_Id" class="ServiceInput" style="width:380px;"
                                       placeholder="Улица, дом, корпус" value="<?= $_GET['BOXDeliveryIn_input']; ?>"/>
                                <br/><br/>

                                <label class="titel-form-order required" style="margin-right:125px">Дата
                                    доставки</label><label class="titel-form-order required">Время доставки
                                    (часы)</label><br/>
                                <input type="text" name="DateBOXDeliveryIn" id="DateBOXDeliveryIn_Id"
                                       class="ServiceInput" style="width:190px;" readonly="readonly"
                                       placeholder="__.__.____"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">&nbsp;с</label>
                                <input type="text" maxlength="2" name="Hour1BOXDeliveryIn" id="Hour1BOXDeliveryIn_Id"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>

                                <label class="titel-form-order titel-addres"
                                       style="vertical-align:middle; padding:4px;">по</label>
                                <input type="text" maxlength="2" name="Hour2BOXDeliveryIn" id="Hour2BOXDeliveryIn_Id"
                                       class="ServiceInput numbers" style="width:40px; text-align:center;"
                                       placeholder="__"/>

                                <br/><br/>
                                <label class="titel-form-order required">Контактное лицо</label>
                                <input type="text" name="ContactBOXDeliveryIn" maxlength="100"
                                       id="ContactBOXDeliveryIn_Id" class="ServiceInput" style="width:380px;"
                                       placeholder="ФИО"/>
                                <br/><br/>
                                <label class="titel-form-order required">Контактный телефон</label>
                                <input type="text" name="PhoneBOXDeliveryIn" id="PhoneBOXDeliveryIn_Id"
                                       class="ServiceInput" style="width:380px;" placeholder="Телефон"/>
                            </div>
                        </div>
            ...
            <div class="row" id="div_tip_polupricepa_kontejnera" style="display:none;">
                ...
                <div class="d2l">
                    <div class="mla">
                        <input type="radio" name="tip-polupricepa-kontejnera" style="width:5%; margin-left:0;"
                               data-content="Рефрижератор" id="refrizherator"><label
                                for="refrizherator">Рефрижератор</label>
                        <br/><br/>
                        <input type="radio" name="tip-polupricepa-kontejnera" style="width:5%; margin-left:0;"
                               data-content="Тентованный" id="tentovannyj" checked><label
                                for="tentovannyj">Тентованный</label>
                        <br/><br/>
                        <div class="mla" id="ZadnyayaBokovayaVerxnyaya" style="display:block;">
                            <input type="checkbox" name="tip-polupricepa-kontejnera" data-content="задняя" id="zadnyaya"
                                   checked><label for="zadnyaya">задняя</label><br/>
                            <input type="checkbox" name="tip-polupricepa-kontejnera" data-content="боковая"
                                   id="bokovaya"><label for="bokovaya">боковая</label><br/>
                            <input type="checkbox" name="tip-polupricepa-kontejnera" data-content="верхняя"
                                   id="verxnyaya"><label for="verxnyaya">верхняя</label>
                            <br/><br/>
                        </div>
                        <input type="radio" name="tip-polupricepa-kontejnera" style="width:5%; margin-left:0;"
                               data-content="Изотермический" id="izotermicheskij"><label for="izotermicheskij">Изотермический</label>
                        <br/><br/>
                        <input type="radio" name="tip-polupricepa-kontejnera" style="width:5%; margin-left:0;"
                               data-content="Контейнер" id="kontejner"><label for="kontejner">Контейнер</label>
                        <br/><br/>
                        <input type="radio" name="tip-polupricepa-kontejnera" style="width:5%; margin-left:0;"
                               data-content="Затрудняюсь ответить" id="zatrudnyayus-otvetit"><label
                                for="zatrudnyayus-otvetit">Затрудняюсь ответить</label>
                        <br/><br/>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="div_vid-perevozki" style="display:none;">
                ...
                <div class="d2l">
                    <div class="mla">
                        <input type="radio" name="vid-perevozki" style="width:5%; margin-left:0;"
                               data-content="Железнодорожные" id="zheleznodorozhnye"><label for="zheleznodorozhnye">Железнодорожные</label>
                        <br/><br/>
                        <input type="radio" name="vid-perevozki" style="width:5%; margin-left:0;"
                               data-content="Автомобильные" id="avtomobilnye"><label
                                for="avtomobilnye">Автомобильные</label>
                        <br/><br/>
                        <input type="radio" name="vid-perevozki" style="width:5%; margin-left:0;"
                               data-content="Контейнерные" id="kontejnernye"><label
                                for="kontejnernye">Контейнерные</label>
                        <br/><br/>
                        <input type="radio" name="vid-perevozki" style="width:5%; margin-left:0;" data-content="Авиа"
                               id="avia"><label for="avia">Авиа</label>
                        <br/><br/>
                        <input type="radio" name="vid-perevozki" style="width:5%; margin-left:0;"
                               data-content="Затрудняюсь ответить" id="vid-perevozki-zatrudnyayus-otvetit"
                               checked><label for="vid-perevozki-zatrudnyayus-otvetit">Затрудняюсь ответить</label>
                        <br/><br/>
                    </div>
                    <br/>
                    ...
                    <div class="mla">
                        <input type="checkbox" name="dop-servis-usluga" data-content="Услуга грузоперевозки"
                               id="usluga-gruzoperevozki"><label for="usluga-gruzoperevozki">Услуга
                            грузоперевозки</label>
                        <br/><br/>
                        <input type="checkbox" name="dop-servis-usluga" data-content="Расчёт таможенных платежей"
                               id="raschyot-tamozhennyx-platezhej"><label for="raschyot-tamozhennyx-platezhej">Расчёт
                            таможенных платежей</label>
                        <br/><br/>
                        <input type="checkbox" name="dop-servis-usluga" data-content="Услуга контрактодержателя"
                               id="usluga-kontraktoderzhatelya"><label for="usluga-kontraktoderzhatelya">Услуга
                            контрактодержателя</label>
                        <br/><br/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="d2l" id="div_params_gruz">
                    <div class="mla">
                        <div class="d3">
                            <label class="required" for="weight">Вес</label>
                            <input id="weight" value="<? echo $_GET['weight']; ?>" placeholder="кг" type="text"
                                   class="weight-size-characteristics numbers_comma k-textbox"
                                   style="width:90px; text-align:center; " name="weight" maxlength="10">
                        </div>

                        <div class="d3">
                            <label class="required">Объём</label><br/>
                            <input id="volume" value="<? echo $_GET['volume']; ?>" placeholder="               м3"
                                   class="weight-size-characteristics numbers_comma"
                                   style="width:90px; text-align:center;" name="volume" maxlength="10">
                        </div>
                        <div class="d3">
                            <label class="required">Мест</label><br/>
                            <input id="place" value="<? echo $_GET['place']; ?>" placeholder="              шт"
                                   class="weight-size-characteristics numbers" style="width:90px; text-align:center;"
                                   name="place" maxlength="10">
                        </div>
                ...
                <div class="d2r" id="div_Character_Cargo">
                    ...
                    <div id="mini-calc_List" style="position:inherit; padding:0px;">
                        <div id="city_from_List_cc" name="inputCharakterCargo" class="city-select_List"
                             data-CharacterCargo="text" style="width:400px;">
            ...
            <div class="tab">
                ...
                <button type="button" name="sender" class="tablinks active" onclick="openTab(event, 'tab1-send')"><p
                            class="msect_title"><b>Отправитель</b></p></button>
                <button type="button" name="resiver" class="tablinks" onclick="openTab(event, 'tab2-resiv')"><p
                            class="msect_title"><b>Получатель</b></p></button>
                <button type="button" name="payer" class="tablinks" onclick="openTab(event, 'tab3-pay')"><p
                            class="msect_title"><b>Плательщик</b></p></button>
            </div>
            <div id="tabs-srp">
                <div id="tab1-send" class="tabcontent row">
                    ...
                    <div style="float:left; height:440px;">
                        <div class="left-menu-order" style="margin-top:69px;">
                            ...
                            <input type="radio" name="typeClientSend" id="typeClientSend_fis_id" style="width:29px"
                                   data-show-fis=".next">
                        ...
                        <div class="left-menu-order" style="margin-top:171px;">
                            ...
                            <input type="radio" name="typeClientSend" id="typeClientSend_ur_id" checked="checked"
                                   style="width:29px" data-show-ur=".next">
                    ...
                    <div class="data-show-send-content-fis" style="display:none;">
                        <div class="dfull" <? if (!$USER->IsAuthorized()) {
                            echo 'style="display:none;"';
                        } ?>>
                            <br/>
                            <input type="checkbox" id="sender_fis_Zapolnit_lc_Id" name="sender_fis_Zapolnit_lc_Name"/>
                            <label for="sender_fis_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                кабинета</label>
                            <br/>
                        </div>
                        ...
                        <div class="d2l" style="width:44%;">
                            ...
                            <input type="text" maxlength="100" name="sender_fis_Contact" id="sender-fis-Contact_Id"
                                   class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                        </div>

                        <div class="d2r" style="width:44%;">
                            <br/><br/>
                            <label class="required">Контактный телефон</label><br/>
                            <input type="text" name="sender_fis_Phone" id="sender-fis-Phone_Id"
                                   class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                        </div>
                        ...
                        <div class="d2l" style="width:44%;">
                            ...
                            <input type="text" maxlength="14" name="sender_fis_SDoc" id="sender-fis-SDoc_Id"
                                   class="ServiceInput not_ignor" style="width:330px;" placeholder="Серия"/>
                            <br/>
                            <br/>
                        </div>
                        ...
                        <div class="d2r" style="width:44%;">
                            ...
                            <input type="text" maxlength="14" name="sender_fis_NDoc" id="sender-fis-NDoc_Id"
                                   class="ServiceInput not_ignor" style="width:330px;" placeholder="Номер"/>
                            <br/>
                            <br/>
                        </div>
                    ...
                    <div class="data-show-send-content-ur" style="display:block;">
                        ...
                        <div class="dfull" <? if (!$USER->IsAuthorized()) {
                            ...
                            <label for="sender_ur_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                кабинета</label>
                            <br/>
                        </div>
                        ...
                        <div class="dfull">
                            ...
                            <input type="text" id="sender-ur-Name_Id" class="ServiceInput not_ignor" maxlength="90"
                                   style="width:715px;" placeholder="Полное название организации"
                                   name="sender_ur_Name"/>
                        </div>
                        ...
                        <div class="dfull">
                            ...
                            <input type="text" name="sender_ur_OrgPravForm" id="sender-ur-OrgPravForm_Id"
                                   class="ServiceInput not_ignor" style="width:715px;" maxlength="10"
                                   placeholder="ООО, ОАО, ЗАО, ИП"/>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                ...
                                <input type="text" maxlength="12" name="sender_ur_INN" id="sender-ur-INN_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="ИНН"/>
                                <br/>
                            ...
                            <div class="d2r">
                                ...
                                <input type="text" maxlength="9" name="sender_ur_KPP" id="sender-ur-KPP_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="КПП"/>
                                <br/>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">Контактное лицо</label><br/>
                                <input type="text" maxlength="100" name="sender_ur_Contact" id="sender-ur-Contact_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                                <br/>
                                <br/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/>
                                <label class="required">Контактный телефон</label><br/>
                                <input type="text" name="sender_ur_Phone" id="sender-ur-Phone_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                                <br/>
                                <br/>
                            </div>
                ...
                <div id="tab2-resiv" class="tabcontent row">
                    ...
                    <div style="float:left; height:440px;">
                        <div class="left-menu-order" style="margin-top:69px;">
                            ...
                            <input type="radio" name="typeClientResiv" id="typeClientResiv_fis_id" style="width:29px"
                                   data-show-fis=".next">
                        ...
                        <div class="left-menu-order" style="margin-top:171px;">
                            ...
                            <input type="radio" name="typeClientResiv" id="typeClientResiv_ur_id" checked="checked"
                                   style="width:29px" data-show-ur=".next">
                    ...
                    <div class="data-show-resiv-content-fis" style="display:none;">
                        <div class="dfull">
                            <div class="d2l" <? if (!$USER->IsAuthorized()) {
                                echo 'style="display:none;"';
                            } ?>>
                                <br/>
                                <input type="checkbox" id="resiv_fis_Zapolnit_lc_Id" name="resiv_fis_Zapolnit_lc_Name"/>
                                <label for="resiv_fis_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                    кабинета</label>
                                <br/>
                            </div>
                            <div class="d2r">
                                <label id="LBLresiv_fis_IsSenderIsPayer"
                                       style="color:red; font-style:italic; display:block; font-size:small; padding:3px; display:none;"></label>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/><br/>
                                <label class="required">Контактное лицо</label><br/>
                                <input type="text" maxlength="100" name="resiv_fis_Contact" id="resiv-fis-Contact_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/><br/>
                                <label class="required">Контактный телефон</label><br/>
                                <input type="text" name="resiv_fis_Phone" id="resiv-fis-Phone_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                            </div>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">Серия</label><br/>
                                <input type="text" maxlength="14" name="resiv_fis_SDoc" id="resiv-fis-SDoc_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Серия"/>
                                <br/>
                                <br/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/>
                                <label class="required">Номер документа</label><br/>
                                <input type="text" maxlength="14" name="resiv_fis_NDoc" id="resiv-fis-NDoc_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Номер"/>
                                <br/>
                                <br/>
                            </div>
                    ...
                    <div class="data-show-resiv-content-ur" style="display:block;">
                        <div class="dfull">
                            <div class="d2l" <? if (!$USER->IsAuthorized()) {
                                ...
                                <label for="resiv_ur_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                    кабинета</label>
                                <br/>
                            </div>
                            <div class="d2r">
                                <label id="LBLresiv_ur_IsSenderIsPayer"
                                       style="color:red; font-style:italic; display:block; font-size:small; padding:3px; display:none;"></label>
                        ...
                        <div class="dfull">
                            <br/>
                            <label class="required">Название организации</label><br/>
                            <input type="text" name="resiv_ur_Name" id="resiv-ur-Name_Id" class="ServiceInput not_ignor"
                                   style="width:715px;" maxlength="90" placeholder="Полное название организации"/>
                        </div>

                        <div class="dfull">
                            <br/>
                            <label class="required">Организационно-правовая форма</label><br/>
                            <input type="text" name="resiv_ur_OrgPravForm" id="resiv-ur-OrgPravForm_Id"
                                   class="ServiceInput not_ignor" style="width:715px;" maxlength="10"
                                   placeholder="ООО, ОАО, ЗАО, ИП"/>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">ИНН</label><br/>
                                <input type="text" maxlength="12" name="resiv_ur_INN" id="resiv-ur-INN_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="ИНН"/>
                                <br/>
                            ...
                            <div class="d2r">
                                ...
                                <input type="text" maxlength="9" name="resiv_ur_KPP" id="resiv-ur-KPP_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="КПП"/>
                                <br/>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">Контактное лицо</label><br/>
                                <input type="text" maxlength="100" name="resiv_ur_Contact" id="resiv-ur-Contact_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                                <br/>
                                <br/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/>
                                <label class="required">Контактный телефон</label><br/>
                                <input type="text" name="resiv_ur_Phone" id="resiv-ur-Phone_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                                <br/>
                                <br/>
                            </div>
                ...
                <div id="tab3-pay" class="tabcontent row">
                    ...
                    <div style="float:left; height: 440px;">
                        ...
                        <div class="left-menu-order" style="margin-top:171px;">
                            ...
                            <input type="radio" name="typeClientPay" id="typeClientPay_ur_id" checked="checked"
                                   style="width:29px">
                    ...
                    <div class="data-show-pay-content-fis" style="display:none;">
                        ...
                        <div class="dfull">
                            <div class="d2l" <? if (!$USER->IsAuthorized()) {
                                ...
                                <label for="pay_fis_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                    кабинета</label>
                                <br/>
                            </div>
                            <div class="d2r">
                                <label id="LBLPayer_fis_IsSenderIsPayer"
                                       style="color:red; font-style:italic; display:block; font-size:small; padding:3px; display:none;"></label>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/><br/>
                                <label class="required">Контактное лицо</label><br/>
                                <input type="text" maxlength="100" name="pay_fis_Contact" id="pay-fis-Contact_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/><br/>
                                <label class="required">Контактный телефон</label><br/>
                                <input type="text" name="pay_fis_Phone" id="pay-fis-Phone_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                            </div>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">Серия</label><br/>
                                <input type="text" name="pay_fis_SDoc" maxlength="14" id="pay-fis-SDoc_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Серия"/>
                                <br/>
                                <br/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/>
                                <label class="required">Номер документа</label><br/>
                                <input type="text" maxlength="14" name="pay_fis_NDoc" id="pay-fis-NDoc_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Номер"/>
                                <br/>
                                <br/>
                            </div>
                    ...
                    <div class="data-show-pay-content-ur" style="display:block;">
                        ...
                        <div class="dfull">
                            <div class="d2l" <? if (!$USER->IsAuthorized()) {
                                ...
                                <label for="pay_ur_Zapolnit_lc_Id">Заполнить моими реквизитами из личного
                                    кабинета</label>
                                <br/>
                            </div>
                            <div class="d2r">
                                <label id="LBLPayer_ur_IsSenderIsPayer"
                                       style="color:red; font-style:italic; display:block; font-size:small; padding:3px; display:none;"></label>
                        ...
                        <div class="dfull">
                            <br/>
                            <label class="required">Название организации</label><br/>
                            <input type="text" name="pay_ur_Name" id="pay-ur-Name_Id" class="ServiceInput not_ignor"
                                   maxlength="90" style="width:715px;" placeholder="Полное название организации"/>
                        </div>

                        <div class="dfull">
                            <br/>
                            <label class="required">Организационно-правовая форма</label><br/>
                            <input type="text" name="pay_ur_OrgPravForm" id="pay-ur-OrgPravForm_Id"
                                   class="ServiceInput not_ignor" style="width:715px;" maxlength="10"
                                   placeholder="ООО, ОАО, ЗАО, ИП"/>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">ИНН</label><br/>
                                <input type="text" maxlength="12" name="pay_ur_INN" id="pay-ur-INN_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="ИНН"/>
                                <br/>
                            </div>
                            <div class="d2r">
                                <br/>
                                <label style="margin-top:9px;">КПП</label><br/>
                                <input type="text" maxlength="9" name="pay_ur_KPP" id="pay-ur-KPP_Id"
                                       class="ServiceInput not_ignor numbers" style="width:330px;" placeholder="КПП"/>
                                <br/>
                            </div>
                        </div>
                        ...
                        <div class="dfull">
                            <div class="d2l">
                                <br/>
                                <label class="required">Контактное лицо</label><br/>
                                <input type="text" maxlength="100" name="pay_ur_Contact" id="pay-ur-Contact_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="ФИО"/>
                                <br/>
                                <br/>
                            </div>
                            ...
                            <div class="d2r">
                                <br/>
                                <label class="required">Контактный телефон</label><br/>
                                <input type="text" name="pay_ur_Phone" id="pay-ur-Phone_Id"
                                       class="ServiceInput not_ignor" style="width:330px;" placeholder="Телефон"/>
                                <br/>
                                <br/>
                            </div>
            ...
            <div class="mla">
                ...
                <br/>
                <br/>
                <p style="font-size: 12px"><span style="color: brown">* </span>Подписание настоящей заявки означает
                    согласие Заказчика (акцепт) с предложением (оферта) Исполнителя заключить <a
                            href="https://www.sibtrans.ru/upload/iblock/c0d/Dogovor-publichnoy-oferty-BTK-aktualnaya-redaktsiya-_Sberbank_.pdf"
                            target="_blank" style="color: brown; cursor: pointer; text-decoration: none;">договор</a>,
                    текст которого размещен на сайте Исполнителя в информационно-коммуникационной сети "Интернет" по
                    адресу: www.sibtrans.ru. Заказчик ознакомлен с условиями договора, принимает их полностью и
                    безоговорочно.</p>
                <br/>
